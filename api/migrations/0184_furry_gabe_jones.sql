-- Reconcile databases that previously ran the rtsp-publish-experiment
-- migration numbers with databases following the upstream migration history.
...
END $$;
--> statement-breakpoint
ALTER TABLE "profile_overlays" ADD COLUMN IF NOT EXISTS "coordinates" jsonb;
--> statement-breakpoint
ALTER TABLE "video_lease" ADD COLUMN IF NOT EXISTS "publish_protocol" text DEFAULT 'hls' NOT NULL;
